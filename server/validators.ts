...
export class FoundationValidator implements IndependentValidator {
  public validate(
    ...
    return {
      ...
      reasoningScorePct: Math.round((completenessPct + assumptionQualityPct) / 2),
      calculationScorePct: mathScorePct,
      sourceGroundingPct: groundingScorePct,
      constraintCompliancePct: codeCompliancePct,
...
export class GenericValidator implements IndependentValidator {
  public validate(
    ...
    return {
      ...
      scenarioId: scenario.scenarioId,
      agentRoleId: execution.agentRoleId,
      reasoningScorePct: 85,
      calculationScorePct: 90,
      sourceGroundingPct: groundingScorePct,
      constraintCompliancePct: 90,
